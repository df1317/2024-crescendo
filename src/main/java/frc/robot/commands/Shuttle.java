...
public class Shuttle extends Command {
    ...
    // REMOVE ME IF EVERYTHING WORKSSSSSSSSSS
    /*
     * private ArmSubsystem m_ArmSubsystem;
     * private Controllers m_Controllers;
     * 
     ...
     * left ? -m_Controllers.leftJoystickPosistion() :
     * -m_Controllers.rightJoystickPosistion());
     * return left ? -m_Controllers.leftJoystickPosistion() :
     * -m_Controllers.rightJoystickPosistion();
     * 
     * }
     * 
     ...
     * double armAngle = (ArmSubsystem.armRange * percent) +
