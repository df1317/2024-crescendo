...
public class SwereDynamic extends Command {
    ...
    public SwereDynamic(SwerveSubsystem swerveSubsystem, Trigger endButton, SysIdRoutine.Direction direction) {
    ...
    public void initialize() {
        m_SwerveSubsystem.sysIdDynamic(direction);
    }
